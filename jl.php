...
<head>
  ...
  <!-- quote style -->
  <link rel="stylesheet" href="css/quotes_css/jl.css" />
...
<div class="row">
	...
	<div class="row">
		<div class="large-12 columns">
			<span class="cursive">Life happens to you while</span> <br>
			<span class="light">you're busy making other plans</span><br>
			<span class="credit"> - John Lennon</span>
		</div>
	</div>
  ...
  <footer class="row">
    <div class="large-12 columns">
        <hr>
        <a href="https://twitter.com/share" class="twitter-share-button" data-text="&quot;Life happens to you while you're busy making other plans.&quot; -John Lennon" data-via="TypeInspiration">Tweet</a>
